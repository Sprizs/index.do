...
var pageData = {
  ...
  'index': function indexData() {
    ...
    var echartsA = echarts.init(document.getElementById('contents'));
    option = {
      tooltip: {
        trigger: 'axis',
      },
...
$('.skiner-color').on('click', function() {
...
$('.tpl-header-switch-button').on('click', function() {
  $('.left-sidebar, .tpl-content-wrapper').toggleClass('active');
});
